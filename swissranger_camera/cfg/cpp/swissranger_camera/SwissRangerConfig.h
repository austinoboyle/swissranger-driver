...
public:
  ...
  public:
    ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
                     std::string a_description, std::string a_edit_method, T SwissRangerConfig::*a_f) : AbstractParamDescription(a_name, a_type, a_level, a_description, a_edit_method),
                                                                                                        field(a_f)
    {
    }
  ...
  public:
    ...
    void setParams(SwissRangerConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if ("frame_id" == (*_i)->name)
        {
          frame_id = boost::any_cast<std::string>(val);
        }
        if ("camera_info_url" == (*_i)->name)
        {
          camera_info_url = boost::any_cast<std::string>(val);
        }
        if ("auto_exposure" == (*_i)->name)
        {
          auto_exposure = boost::any_cast<int>(val);
        }
        if ("integration_time" == (*_i)->name)
        {
          integration_time = boost::any_cast<int>(val);
        }
        if ("amp_threshold" == (*_i)->name)
        {
          amp_threshold = boost::any_cast<int>(val);
        }
      }
    }
...
class SwissRangerConfigStatics
{
  ...
  SwissRangerConfigStatics()
  {
    ...
    //#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
    Default.abstract_parameters.push_back(SwissRangerConfig::AbstractParamDescriptionConstPtr(new SwissRangerConfig::ParamDescription<int>("auto_exposure", "int", 0, "Auto exposure control state.", "{'enum_description': 'Feature control states', 'enum': [{'srcline': 54, 'description': 'Use fixed value', 'srcfile': '/home/elec490/playground_ws/src/swissranger_camera/cfg/SwissRanger.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Off'}, {'srcline': 55, 'description': 'Camera sets continuously', 'srcfile': '/home/elec490/playground_ws/src/swissranger_camera/cfg/SwissRanger.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Auto'}]}", &SwissRangerConfig::auto_exposure)));
    //#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 54 "/home/elec490/playground_ws/src/swissranger_camera/cfg/SwissRanger.cfg"
const int SwissRanger_Off = 0;
//#line 55 "/home/elec490/playground_ws/src/swissranger_camera/cfg/SwissRanger.cfg"
